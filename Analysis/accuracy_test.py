...
def save_confusion_matrix(model, device, test_loader, title=" ", class_number=10, save_path=None, classes=('plane', 'car', 'bird', 'cat',
    ...
    # plt.show()
    if save_path:
        save = os.path.join(save_path,title+".jpg")
        plt.savefig(save)
    plt.show()
